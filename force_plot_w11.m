files = ["D:\F1 comparison report\W11 data\forces\20ms.csv";
    "D:\F1 comparison report\W11 data\forces\30ms.csv";
    "D:\F1 comparison report\W11 data\forces\40ms.csv";
    "D:\F1 comparison report\W11 data\forces\50ms.csv";
    "D:\F1 comparison report\W11 data\forces\60ms.csv";
    "D:\F1 comparison report\W11 data\forces\70ms.csv";];
cutoffTime = 300;   % seconds threshold for averages
...
for i = 1:numel(files)
    ...
    figure(1);
    plot(t, Fy, 'LineWidth', 1.4, 'DisplayName', strcat(num2str(velocity), ' m/s'));
